...
class Features(BaseModel):
    ...
    calculated_host_listings_count: int = Field(..., ge=0, description="Number of listings the host")
    availability_365: int = Field(..., ge=0, le=365, description="Days available out of 365")
    neighbourhood_group: str = Field(..., description="Borough or neighbourhood group")
    neighbourhood: str = Field(..., description="Specific Neighbourhood name")
...
def predict(features : Features):
    ...
    return {"Predicted_room_type" : prediction.tolist(),
